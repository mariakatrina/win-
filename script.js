...
var ballColour = [[(color(rgb(92, 75, 81),rgb(140, 190, 178),rgb(242, 235, 191)))]];
var dx = 1.5, dy = -1.5;
// add a small value to x and y after every frame has been drawn to make it appear that the ball is moving
// defined as dx and dy, these are the changable variables
...
var paddleColour = [[(color(rgb(242, 235, 191),rgb(243, 181, 98),rgb(240, 96, 96)))]]
...
//   THIS FN IS THE MAIN DRAW FN
  function draw() {
    ...
    if(x + dx > canvas.width-ballRadius 
        ...
        || x + dx < ballRadius) 
        // If the x value of the ball position is lower than the ballRadius, 
        // change the direction of the movement on the x axis by setting it equal to itself, reversed
        {
        dx = -dx;
